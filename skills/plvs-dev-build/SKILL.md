...
Produces a throwaway **dev installer and Portable ZIP** for testing, downloadable from GitHub.
...
installer + Portable ZIP, then **replaces** the `dev` Pre-release so it always
