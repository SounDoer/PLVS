...
const installSection = [
  ...
  `- **便携版**：下载 \`PLVS-v${semver}-x64-portable.zip\`，解压后运行 \`plvs.exe\`；请将 \`plvs-cli.exe\` 保留在同一目录。`,
  ...
  `- **Portable**: Download \`PLVS-v${semver}-x64-portable.zip\`, extract it, then run \`plvs.exe\`; keep \`plvs-cli.exe\` in the same directory.`,
