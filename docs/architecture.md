...
│   │
│   ├── dock/                     # dock mode: edge strip modules + 1-D layout
│   │   │                         # (spec: docs/superpowers/specs/2026-07-11-dock-mode-design.md)
│   │   ├── registry.jsx          # dock module catalog (level/loudness/spectrum/correlation)
│   │   ├── DockStrip.jsx         # strip container: modules row + hover controls + editors
│   │   └── …                     # dockLayout, useDockLayout, dockAnalysisRequest, modules/, editors/
│   │
│   └── generated/
