...
│   │   ├── DockStrip.jsx         # reserved meter-only strip
...
│
├── src-tauri/
│   ├── Cargo.toml                # workspace root + plvs application package
│   ├── plvs-cli/                 # independent thin Agent Control forwarder package
│   ├── tauri.cli-sidecar.conf.json # explicit CLI external-binary packaging overlay
