...
All PLVS Dark traces are in the orange family — distinguished by lightness only.

| Token | Value | Role |
|-------|-------|------|
| `--ui-chart-momentary` | `#fb923c` | Loudness M · live (primary orange) |
| `--ui-chart-momentary-snap` | `#fcd34d` | Loudness M · snap (light gold) |
| `--ui-chart-shortterm` | `#e8824a` | Loudness ST · live (copper orange) |
| `--ui-chart-shortterm-snap` | `#fed7aa` | Loudness ST · snap (pale orange) |
...
| `--ui-chart-target-line` | `rgba(251,146,60,0.4)` | Loudness target reference line |
