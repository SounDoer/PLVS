...
Spectrum 与 Stereo Map 的行已移出 JSON（生产宽度一帧 131,886 B → 47,496 B）；
...
| Panel       | D1                                           | D2                                                                  | D3                                    | D4                                    |
| ----------- | -------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------- | ------------------------------------- |
| Spectrum    | 合理性已落地，正确性已有覆盖                 | 计算部分已测并优化；paint 已量（471.5 次/秒，最高），改动待议                                      | 已测，无水分，有损手段均拒绝          | 三层全部已落地，dB 行 −58%/行；真实窗口待验 |
