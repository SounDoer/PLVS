...
mod tests {
  ...
  fn root_help_exposes_flat_control_families() {
    ...
    for command in [
      ...
      "plvs-cli inspect",
      "plvs-cli wait",
      "workspace|panel|axis|preset|theme|loudness-profile|settings|transport|device|dock",
    ] {
