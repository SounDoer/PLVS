...
export const SHELL_FOOTER =
  "flex shrink-0 flex-wrap items-center gap-x-2 gap-y-1 rounded-[var(--radius)] border border-border bg-card/60 px-[var(--ui-footer-pad-x)] py-[var(--ui-footer-pad-y)] text-[length:var(--ui-fs-status)] leading-[1.35] text-muted-foreground shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] backdrop-blur-[14px] backdrop-saturate-[140%]";
