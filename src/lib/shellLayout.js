...
export const SHELL_HEADER_OVERLAY = `absolute left-[var(--ui-shell-pad)] right-[var(--ui-shell-pad)] top-[var(--ui-shell-pad)] flex shrink-0 items-center gap-3 border-border bg-card/85 py-[var(--ui-header-pad-y)] shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_8px_24px_rgba(0,0,0,0.18)] z-30 ${SHELL_SURFACE_BASE}`;
...
export const PANEL_HEADER_ACTION_BUTTON =
  "rounded p-0.5 text-muted-foreground opacity-50 hover:opacity-100";
...
export const W_PEAK_TICKS = "w-[var(--ui-chart-y-axis-rail-w)]";
export const W_LOUDNESS_Y_AXIS = "w-[var(--ui-chart-y-axis-rail-w)]";
