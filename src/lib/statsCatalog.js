...
export const STATS_META = {
  ...
  dialogueCoverage: {
    ...
    shortLabel: "Dlg Cov",
    unit: "%",
    hint: "Share of time dialogue is detected. Set by Dialogue Detection in Settings",
  },
  dialogueIntegrated: {
    label: "Dialogue Integrated",
    shortLabel: "Dlg I",
    unit: "LUFS",
    hint: "Loudness over dialogue only. Set by Dialogue Detection in Settings",
  },
  dialogueRange: {
    label: "Dialogue Range",
    shortLabel: "Dlg LRA",
    unit: "LU",
    hint: "Loudness range over dialogue only. Set by Dialogue Detection in Settings",
  },
  dialogueOffset: {
    label: "Dialogue Offset",
    shortLabel: "Dlg Offset",
    unit: "LU",
    hint: "Dialogue loudness relative to the overall mix. Set by Dialogue Detection in Settings",
  },
  truePeak: {
    label: "True Peak Max",
    shortLabel: "TP Max",
