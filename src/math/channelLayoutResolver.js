 ...
 * @typedef {"unknown" | "mono" | "stereo" | "lcr" | "quad" | "surround50" | "5.1" | "7.0" | "7.1"} ResolvedChannelLayout
 *
...
export function resolveChannelLayout(setting, ctx) {
  ...
  // Auto mode: map supported channel counts to their layout; unsupported counts stay unknown.
