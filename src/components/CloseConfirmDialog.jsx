...
const SELECT_TRIGGER_CLASS =
  "h-6 w-auto shrink-0 rounded-md border border-transparent bg-transparent px-2 py-0 text-xs text-popover-foreground shadow-none outline-none transition-colors hover:border-border hover:bg-secondary/85 focus:ring-0 focus:ring-offset-0 focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-0";

const SELECT_CONTENT_CLASS =
  "border-border/50 min-w-[var(--radix-select-trigger-width)] [&_[data-slot=select-item]]:py-1 [&_[data-slot=select-item]]:pr-6 [&_[data-slot=select-item]]:pl-2 [&_[data-slot=select-item]]:text-xs [&_[data-slot=select-item]]:hover:bg-secondary/85";
...
const ROW_LABEL_CLASS = "text-xs font-medium text-muted-foreground";
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 z-50 inline-flex -translate-x-1/2 -translate-y-1/2 flex-col rounded-lg border border-border bg-card p-3 shadow-xl focus:outline-none">
          ...
          <div className="flex justify-end gap-1.5">
            <button
              ...
              className="rounded-md px-2 py-0.5 text-xs text-muted-foreground transition-colors hover:bg-secondary"
            >
              Cancel
            </button>
            <button
              ...
              className="rounded-md bg-primary px-2 py-0.5 text-xs text-primary-foreground transition-colors hover:bg-primary/90"
            >
              Confirm
            </button>
          </div>
